...
Use a pinned version when you need reproducible runs. This example uses Copilot CLI <code>0.0.394</code>, matching the bundled version called out in the gh-aw v0.64.0 release notes.
