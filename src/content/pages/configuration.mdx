...
Use a pinned version when you need reproducible runs. This example uses Copilot CLI <code>0.0.394</code>, a known release-bundled version that makes the pinning example concrete.
